/*
    ...
    아직 본문(body)이 도착하기 전이지만 개발자는 응답 헤더를 보고 요청이 성공적으로 처리되었는지 알 수 있다.
...
async function callApi(){
    ...
    // const promise = await fetch("https://jsonplaceholder.typicode.com/users").then(response => response.json());
    // console.log(promise);

...
import { modifyMenu } from "../../modules/MenuModule";
import { callModifyMenuAPI } from "../../apis/MenuAPICalls";

const MenuModifyForm = () => {
    ...
    const onChangeHandler = e => {
        ...
        switch(name){
            case "menuPrice" : value = parseInt(value); break;
            case "isOrderable" : value = !!value; break;
            case "description" : name="detail"; value= {
                description:value,
                image : modifyMenu.detail.imange
            }; break;
